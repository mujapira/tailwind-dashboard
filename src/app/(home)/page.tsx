...
export default function Home() {
  return (
    <>
      ...
      <form
        id="settings"
        className="flex flex-col w-full gap-5 mt-6 divide-y divide-zinc-200 dark:divide-zinc-800"
      >
          ...
          <div className="flex gap-3">
            <Input.Root>
              ...
              <Input.Control
                ...
                type="email"
                name="email"
                defaultValue="mauriciompdev@gmail.com"
              />
            </Input.Root>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-3">
            <div className="grid gap-3 lg:grid-cols-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <Button variant="ghost">
                  <Link className="w-4 h-4 text-zinc-400" strokeWidth={3} />
                </Button>
                <Button variant="ghost">
